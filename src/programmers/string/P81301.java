...
public class P81301 {
    ...
    private boolean matchDigit(String str) {
        if (str.equals("zero") || str.equals("one") || str.equals("two") || str.equals("three") || str.equals("four")
                || str.equals("five") || str.equals("six") || str.equals("seven") || str.equals("eight") || str.equals(
                "nine")) {
            return true;
        }
        return false;
